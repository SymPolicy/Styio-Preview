...
constexpr std::array kUsageCommands = {
    ...
    UsageCommandEntry{
        "doctor",
        "usage: pafio doctor [--json] [--manifest-path <path>] [--release-root <url>] [--channel <stable|nightly>]\n",
    },
    UsageCommandEntry{
        "project-graph",
    ...
    UsageCommandEntry{
        "install",
        "usage: pafio install styio[@latest] [--release-root <url>] [--source|--prebuilt-only] [--source-root <path>] [--source-rev <ref>] [--channel <stable|nightly>] [--build <minimal>] [--yes|--no-fetch|--offline|--non-interactive]\n",
    },
    UsageCommandEntry{
        "use",
    ...
    UsageCommandEntry{
        ...
        "  pafio tool list [--json]\n"
        "  pafio tool status --json [--manifest-path <path>]\n"
        "  pafio tool update [styio[@latest]] [--release-root <url>] [--channel <stable|nightly>]\n"
        "  pafio tool uninstall --version <compiler-version> [--channel <channel>]\n"
