...
Before moving `pafio` to `/Users/unka/DevSpace/Unka-Malloc/styio-pafio`, keep this document and update it to point at the standalone `styio` repository checkout location used by the team.
...
Before the subtree moves to `/Users/unka/DevSpace/Unka-Malloc/styio-pafio`, confirm:
