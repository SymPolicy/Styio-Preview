...
| `Pafio-Pafio-Migration-Handoff.md` | [Pafio Platform Migration Handoff](./Pafio-Pafio-Migration-Handoff.md) | Define the local package-manager-to-global-platform boundary after moving server, package-distribution, and compile-platform ownership into pafio. |
...
| `Styio-Ecosystem-Delivery-Master-Plan.md` | [Styio Ecosystem Delivery Master Plan](./Styio-Ecosystem-Delivery-Master-Plan.md) | 作为 styio-pafio 对三仓统一交付总纲的镜像入口，固定 pafio 在每个里程碑中的职责、文档落点和本仓 gate。 |
| `Styio-Ecosystem-File-Governance-Alignment-Plan.md` | [Styio Ecosystem File Governance Alignment Plan](./Styio-Ecosystem-File-Governance-Alignment-Plan.md) | 作为 styio-pafio 对三仓文件治理对齐计划的镜像入口，固定 pafio 在文件治理、文档生命周期、repo hygiene 和脚本复用上的职责与本仓出口。 |
