...
- maintain a clean extraction path to `/Users/unka/DevSpace/Unka-Malloc/styio-pafio`
...
- actual move to `/Users/unka/DevSpace/Unka-Malloc/styio-pafio`
...
- `pafio_styio_interface_gate_handshake` + `pafio_styio_interface_gate_compile_plan` are passing, confirming the baseline `styio` machine-info/compile-plan handoff test path (`ctest --test-dir /home/unka/styio-pafio/build-codex --output-on-failure`).
