...
6. Platform migration handoff: [planning/Pafio-Pafio-Migration-Handoff.md](./planning/Pafio-Pafio-Migration-Handoff.md)
...
- `registry/` — registry v2 static read-plane, package-manager client contracts, offline package expectations, and server control-plane handoff notes pointing to `pafio`
...
20. `planning/Pafio-Pafio-Migration-Handoff.md`
