...
| Path | Entry | Summary |
|------|-------|---------|
| `Pafio-Alpha-Release-Checklist.md` | [Pafio Alpha Release Checklist](./Pafio-Alpha-Release-Checklist.md) | Define the concrete closure checklist for publishing pafio v0.1.0-alpha without implying npm-level package-manager maturity. |
...
| `Pafio-Repo-Split-Runbook.md` | [Pafio Repository Split Runbook](./Pafio-Repo-Split-Runbook.md) | Describe the exact preflight, copy, and post-copy sequence for moving pafio out of the current workspace into /Users/unka/DevSpace/Unka-Malloc/styio-pafio. |
