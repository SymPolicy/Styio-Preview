...
**Purpose:** Describe the exact preflight, copy, and post-copy sequence for moving `pafio` out of the current workspace into `/Users/unka/DevSpace/Unka-Malloc/styio-pafio`.
...
```text
./scripts/copy-to-external-repo.sh /Users/unka/DevSpace/Unka-Malloc/styio-pafio
```
...
Inside `/Users/unka/DevSpace/Unka-Malloc/styio-pafio`, run:
...
- keep offline package use, local package import/export, and project-local Styio environment optimization in `styio-pafio`
