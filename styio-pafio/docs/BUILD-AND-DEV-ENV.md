...
`styio-pafio` and `styio-nightly` share the same standardized native baseline:
...
The default source-build origin is `https://github.com/SymPolicy/Styio-Preview.git`, and the project channel selects the matching source branch:
