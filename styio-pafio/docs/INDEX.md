...
| `registry/` | [Registry Index](./registry/INDEX.md) | Separate local package-manager registry client and offline package rules from server-side package distribution and registry control-plane ownership now moved to pafio. |
