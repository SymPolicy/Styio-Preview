...
Scope: `resolver`, `manifest`, `toolchain`, `process lifecycle`, `state machine`, `timeout`, tests, and gates in `styio-pafio`.
...
- `cmake --build /home/unka/styio-pafio/build-codex --target pafio_native_tests -j2`
- `/home/unka/styio-pafio/build-codex/bin/pafio_native_tests --gtest_filter='ProcessTests.StreamsLargeStdinWhileDrainingStdout:ResolverTests.ResolvesLargeGitSnapshotsWithoutArchiveTruncation'`
- `/home/unka/styio-pafio/build-codex/bin/pafio_native_tests --gtest_filter='ProcessTests.*:ResolverTests.*'`
