...
**Purpose:** Record the frontend-facing hosted workspace API that `Vityo` consumes from `pafio` so UI and backend teams can ship independently against a fixed contract package.
