...
9. hosted execution、hosted workspace、project graph、dependency source、deployment 和 toolchain state 都必须通过 versioned payload / adapter contract 进入前端，不允许读 `pafio` 私有目录或解析 human stderr。
